 ...
 * test-indices.js
 * 
 * Automated verification suite for SIH26076 Mausam Algorithmic Indices (Part 7).
 * Tests all 6 indices for:
 * 1. Mathematical validity and range clamping
 * 2. Boundary conditions (extreme heat, freezing, gale wind, zero wind, 100% humidity, dense fog, hazardous AQI)
 * 3. Explainability (formula, factor breakdown, medical disclaimer)
 * 4. Deterministic non-random behavior
 */
...
// Extreme heat & humidity boundary (heatwave)
...
// ----------------------------------------------------
// 2. EXERCISE COMFORT INDEX TESTS
// ----------------------------------------------------
console.log('\nTEST GROUP 2: Exercise Comfort Index');

// Ideal running conditions (16°C, 45% RH, low UV, light breeze)
...
// Boundary: Freezing temperature (-10°C)
...
// ----------------------------------------------------
// 3. OUTDOOR ENVIRONMENTAL COMFORT INDEX TESTS
// ----------------------------------------------------
console.log('\nTEST GROUP 3: Outdoor Environmental Comfort Index');

// Clean air & pleasant conditions
...
// Severe disruption (heavy rain, gale winds, active alerts)
...
// ----------------------------------------------------
// 5. COMMUTE RISK SCORE TESTS
// ----------------------------------------------------
console.log('\nTEST GROUP 5: Commute Risk Score');

// Normal clear commute
...
// ----------------------------------------------------
// 6. AGRI CONDITIONS & SPRAY WINDOW TESTS
// ----------------------------------------------------
console.log('\nTEST GROUP 6: Agricultural Operations Index');

// Favorable spraying conditions (calm wind, no rain, moderate RH)
...
// Excessive wind drift hazard (>15 km/h)
